                ...
                <div className='wizard-questions'>
                    <div>
                        ...
                        <RadioButtonGroup name="pand" defaultSelected="beide" onChange={this.setPandValue.bind(this)}>
                            <RadioButton value="bestaand" label="Ik zoek een bestaand pand" className='custom-radiobutton' iconStyle={{fill: '#730049'}} labelStyle={{color:'#333'}} />
                            <RadioButton value="nieuwbouw" label="Ik wil nieuw bouwen" className='custom-radiobutton' iconStyle={{fill: '#730049'}} labelStyle={{color:'#333'}} />
                            <RadioButton value="beide" label="Geen voorkeur" className='custom-radiobutton' iconStyle={{fill: '#730049'}} labelStyle={{color:'#333'}} />
                        </RadioButtonGroup>
                    </div>
                    <div>
                        ...
                        <RadioButtonGroup name="huur-koop" defaultSelected="beide" onChange={this.setHuurKoopValue.bind(this)}>
                            <RadioButton value="koop" label="Kopen" className='custom-radiobutton' iconStyle={{fill: '#730049'}} labelStyle={{color:'#333'}} />
                            <RadioButton value="huur" label="Huren" className='custom-radiobutton' iconStyle={{fill: '#730049'}} labelStyle={{color:'#333'}} />
                            <RadioButton value="beide" label="Geen voorkeur" className='custom-radiobutton' iconStyle={{fill: '#730049'}} labelStyle={{color:'#333'}} />
                        </RadioButtonGroup>
                    </div>
                    <div>
                        ...
                        <RadioButtonGroup name="plaats" defaultSelected="beide" onChange={this.setPlaatsValue.bind(this)}>
                            <RadioButton value="rijssen" label="Rijssen" className='custom-radiobutton' iconStyle={{fill: '#730049'}} labelStyle={{color:'#333'}} />
                            <RadioButton value="holten" label="Holten" className='custom-radiobutton' iconStyle={{fill: '#730049'}} labelStyle={{color:'#333'}} />
                            <RadioButton value="beide" label="Geen voorkeur" className='custom-radiobutton' iconStyle={{fill: '#730049'}} labelStyle={{color:'#333'}} />
                        </RadioButtonGroup>
                    </div>
                </div>
